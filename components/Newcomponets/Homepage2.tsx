            ...
            {products.map((p: any) => {
              ...
              return (
                <button
                  ...
                  //  className={`group flex flex-col items-center justify-center gap-3 px-4 py-4 rounded-2xl transition-all duration-200 border h-32 sm:h-36 md:h-40
             ...
             <div className="md:col-span-4">
              <div className="bg-[#E6F6FB] rounded-xl p-6 md:p-8 h-[30rem] md:h-full">
                ...
                <p className="text-md text-[#2c6b82] mb-6">
                  ...
                  {/* <SlEnergy className="inline text-orange-400" /> */}
                </p>
