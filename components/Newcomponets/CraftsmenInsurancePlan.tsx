...
import VisitvisaImg from "@/public/assets/Images/ImagesIcons/VisitvisaImg.jpg";
import { useTranslation } from "react-i18next";
import VisitVisapage from "./VisitVisapage";
import HospitalizationExpenses from "../Newcomponets/HospitalizationTable";
import RetailVisitVisaImg from "@/public/assets/Images/Retail/Retail-VisitVisa.png";
import CraftsmenImg from "@/public/assets/Images/Retail/Retail-CraftMen.png";
import CraftsmenInsuranceCards from "@/components/Newcomponets/CraftsmenInsuranceCards";
import CraftsmenCoverageCard from "@/components/Newcomponets/CraftsmenCoverageCard";
// import Craftsmentable from "@/components/Newcomponets/CraftsmenCoverageCard";
import Image from "next/image";
import { planContents } from "@/lib/utilities";
const CraftsmenInsurance: React.FC = () => {
  const { t } = useTranslation("craftsmenInsuranceplan");
  return (
    <>
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-10 lg:mb-[12rem] rtl:mb-[20rem]">
            <Image
              src={CraftsmenImg}
        ...
        <CraftsmenCoverageCard/>
      <CraftsmenInsuranceCards />
      {/* <Craftsmentable/> */}
      {/* <HospitalizationExpenses /> */}
      <div className="w-full max-w-7xl mx-auto mt-10 px-4">
        <Advantages content={planContents?.craftsmeninsuranceplan} />
      </div>
      <FAQs />
    </>
  );
...
export default CraftsmenInsurance;
