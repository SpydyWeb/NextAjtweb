...
import CorporatePropertyImg from "@/public/assets/Images/Corporate/Corporate - Property_.png";
    ...
    <>
      <section className="bg-white">
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="max-w-7xl mx-auto px-4 lg:px-8 py-10 lg:mb-[12rem] rtl:mb-[13rem]">
            <div className="relative z-10 flex flex-col items-center text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 text-sky-600">
                {t("Propertyheader")}
              </h2>

              {/* Buttons same as Marine */}
            ...
            {/* Text Content same style as Marine */}
            <div className="relative z-10 p-10 md:p-20 max-w-lg text-black text-lg text-justify ml-0 lg:ml-[-11rem] mt-4">
              {activeTab === "fire" ? (
                <>
                  ...
                  <p className="leading-relaxed">{t("propertySubDesc1")}</p>
                </>
              ) : (
                <>
                  <h3 className="text-[1.4rem] md:text-[1.5xl] font-bold mb-4 text-sky-600">
