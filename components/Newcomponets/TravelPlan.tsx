                ...
                <table className="w-full text-center border border-white">
                  ...
                  <tbody>
                    {[
                      [
                        "TravelTbRow1",
                        ["37,500", "70,000", "150,000", "650,000", "187,500"],
                      ],
                      [
                        "TravelTbRow2",
                        ["2,000", "2,000", "2,000", "2,000", t("NotCovered")],
                      ],
                      [
                        "TravelTbRow3",
                        ["1,000", "2,000", "2,000", "2,500", "1,500"],
                      ],
                      [
                        "TravelTbRow4",
                      ...
                      [
                        "TravelTbRow7",
                        ["5,000", "5,000", "5,000", "5,000", t("NotCovered")],
                      ],
                      [
                        "TravelTbRow8",
                        ["3,750", "3,750", "3,750", "3,750", t("NotCovered")],
                      ],
                      [
                        "TravelTbRow9",
                        ["3,750", "3,750", "3,750", "3,750", t("NotCovered")],
                      ...
                      [
                        "TravelTbRow12",
                        ["1,875", "1,875", "1,875", "1,875", t("NotCovered")],
                      ],
                      [
                        "TravelTbRow13",
                        [
                      ...
                      <tr key={i}>
                        ...
                        {(values as string[]).map((val, idx) => (
                          <td key={idx} className="p-2 border border-[#10426c]">
                            {val}
                          </td>
                        ))}
                      </tr>
