...
import {aviationCoverages} from "@/lib/utilities";
import { useTranslation } from "react-i18next";

export default function AviationCoverage() {
  ...
  return (
    <div className="flex items-center justify-center  bg-white">
      <div className="rounded-lg border shadow-sm overflow-hidden max-w-2xl w-full">
        {/* Header */}
        <div className=" bg-[#1D3557]  text-white text-center py-3 font-medium text-2xl">
          {/* bg-[#2C9CD4] */}
          {t("Typesofpolicies")}
        </div>
        ...
        {/* Coverage List */}
        <ul>
          {aviationCoverages.map((item, idx) => (
            <li
              key={idx}
