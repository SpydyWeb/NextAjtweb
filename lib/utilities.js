...
export const utilitiesData = {
  ...
  companyProfile: {
    ...
    links: [
      ...
      { "label": "Career", "path": "/careerform" },
      { "label": "Download Center", "path": "/downloadcenter" },
      { "label": "Report a Fraud", "path": "/reportafraud" },
      { "label": "Share Holder", "path": "/shareholderrelation" },
      { "label": "Sharia Committee", "path": "/shariacommitee" },
      { "label": "FAQs", "path": "/faqs" },
      { "label": "Customer Rights", "path": "/customerrights" },
